...
import { Banknote, CarFront, ClipboardList, User } from "lucide-react";
...
/** The driver app's own tabs — deliberately distinct from the rider nav. */
const NAV_ITEMS: readonly NavItem[] = [
  { to: ROUTES.driver, label: "Drive", Icon: CarFront },
  { to: ROUTES.driverEarnings, label: "Earnings", Icon: Banknote },
  { to: ROUTES.driverTrips, label: "Trips", Icon: ClipboardList },
