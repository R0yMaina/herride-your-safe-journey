  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-hidden bg-noir">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-24 left-1/2 h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-ambient-blob blur-3xl" />
        <div className="absolute bottom-0 left-0 h-[320px] w-[320px] rounded-full bg-ambient-blob blur-3xl" />
      </div>
