...
function svgIcon(g: typeof google, kind: "pickup" | "dest" | "driver"): google.maps.Icon {
  const svg =
    kind === "driver"
      ? `<svg xmlns='http://www.w3.org/2000/svg' width='36' height='36'><circle cx='18' cy='18' r='11' fill='%238b5cf6' stroke='%23141414' stroke-opacity='0.6' stroke-width='2'/></svg>`
      : kind === "pickup"
        ? `<svg xmlns='http://www.w3.org/2000/svg' width='22' height='22'><circle cx='11' cy='11' r='6' fill='%238b5cf6' stroke='%23141414' stroke-opacity='0.5' stroke-width='1.5'/></svg>`
        : `<svg xmlns='http://www.w3.org/2000/svg' width='22' height='22'><circle cx='11' cy='11' r='6' fill='none' stroke='%236d28d9' stroke-width='3'/></svg>`;
    ...
    void (async () => {
      try {
        ...
        const renderer = new g.maps.DirectionsRenderer({
          ...
          polylineOptions: { strokeColor: "#8b5cf6", strokeWeight: 4, strokeOpacity: 0.95 },
        });
        stateRef.current = {
          g,
          map,
