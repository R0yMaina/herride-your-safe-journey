...
function markerIcon(
  ...
  if (kind === "driver") {
    ...
    return L.divIcon({
      ...
      html: `<div style="width:34px;height:34px;border-radius:50%;background:linear-gradient(145deg,#a78bfa,#7c3aed);
        display:grid;place-items:center;box-shadow:0 0 0 3px rgba(167,139,250,.35),0 6px 16px rgba(0,0,0,.55);${rot}">
  ...
  const inner =
    kind === "pickup"
      ? `<div style="width:12px;height:12px;border-radius:50%;background:${color};box-shadow:0 0 0 4px rgba(139,92,246,.3),0 1px 4px rgba(0,0,0,.5)"></div>`
