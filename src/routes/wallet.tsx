...
export const Route = createFileRoute("/wallet")({
  head: () => ({ meta: [{ title: "Wallet — HeriRide" }, { name: "description", content: "Manage payments." }] }),
  component: Wallet,
});
        ...
        <div className="px-4">
          <div className="relative rounded-3xl p-5 bg-gradient-pink text-noir overflow-hidden shadow-soft">
            ...
            <div className="relative">
              <div className="text-xs uppercase tracking-wider font-semibold">HeriRide balance</div>
          ...
          <div className="space-y-2">
            ...
            <Method icon={WalletIcon} title="HeriRide Wallet" sub="2% cashback every ride" />
