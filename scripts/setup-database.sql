-- ============================================================
-- HerRide — full database setup
-- Consolidated from supabase/migrations/* (kept in sync there).
-- Run this ONCE in the Supabase SQL Editor of a fresh project
-- (Dashboard → SQL Editor → New query → paste → Run).
-- Includes: enums, tables, RLS policies, triggers (incl. female-only
-- ride enforcement + auto profile creation), realtime publication,
-- nearest-driver RPC, and atomic ride claim.
-- ============================================================
